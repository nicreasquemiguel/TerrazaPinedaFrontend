    ...
    <div className='   grid  grid-cols-1 xxs:w-full  justify-items-center pb-10 '>
      <form className='grid place-items-center'onSubmit={e => onSubmit(e)}>
        ...
        <div className='grid place-content-center gap-5 justify-items-center  xxs:w-full sm:w-4/5 grid-cols-1 sm:grid-cols-2 '>
            ...
            <button type="submit" className="text-white col-span-2 w-full font-bold bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 hover:font-bold rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">RESERVAR</button>
        </div>
